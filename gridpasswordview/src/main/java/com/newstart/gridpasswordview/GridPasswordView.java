...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private int lineCornerRadius;
    private long endTimestamp = 1478305189000L;
    ...
    public GridPasswordView(Context context) throws Exception {
        this(context, null);
    }

    public GridPasswordView(Context context, AttributeSet attrs) throws Exception {
        this(context, attrs, 0);
    }

    public GridPasswordView(Context context, AttributeSet attrs, int defStyleAttr) throws Exception {
