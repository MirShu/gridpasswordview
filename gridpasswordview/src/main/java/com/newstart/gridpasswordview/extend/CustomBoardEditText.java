...
public class CustomBoardEditText extends EditText {
    ...
    private boolean isBackCloseKeyboard = true;
     ...
     * 设置键盘
     *
     * @param isRandomNum 数字键盘是否随机排列 默认不随机
     */
    ...
    public void setBackCloseKeyboard(boolean isBackCloseKeyboard) {
        this.isBackCloseKeyboard = isBackCloseKeyboard;
    }
    ...
    private void init() {
        ...
        keyboardView = (KeyboardView) LayoutInflater.from(context).inflate(R.layout.keyboard_view, null);
        keyboardView.setEnabled(true);
        keyboardView.setPreviewEnabled(false);
        keyboardView.setOnKeyboardActionListener(listener);

        mKeyboardWindow = new PopupWindow(keyboardView, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    // 设置是数字键盘
    public void setNum(final GridPasswordView gridPasswordView, final CustomBoardEditText tradersPasswordBoard) {
        setKeyboard(false);
        // 隐藏系统键盘
        hideSysInput();
        showKeyboard();
